# Spring 2026 Fundamentals of Computing I — Assignment 4
...
1. Log in to GitHub.
2. Fork this repo. See [this video](http://code-warrior.github.io/tutorials/git/github/forking-and-cloning-at-the-github-web-site/) on how to carry out this step and step 3.
3. Clone your fork using either the website or GitHub Desktop.
4. Check out your personalized branch, the one with your name and GitHub handle.

---

## ❖ Introduction ❖

Using basic Java graphics in Processing, create a tic-tac-toe game where the user plays against the computer. A short movie of how this assignment should look and behave in its resolved state is available at [https://roy.vanegas.org/video/tic-tac-toe.mp4](https://roy.vanegas.org/video/tic-tac-toe.mp4).

---

## ❖ Rules ❖

1. The  canvas *must* be 500×500.
